...
async function main() {
  ...
  const realUsers = [
    ...
    { role_id: 3, full_name: 'บริษัท เอสพีเอ็กซ์ เอ็กซ์เพรส จำกัด (HUB)', username: 'SPXadmin', email: '12758thiraphat@gmail.com', company_id: 11 },
    { role_id: 3, full_name: 'บริษัท เอสพีเอ็กซ์ เอ็กซ์เพรส จำกัด (FSOCW-สมุทรสาคร)', username: 'SPXadmin01', email: 'SPXadmin01@gmail.com', company_id: 12 },
    { role_id: 3, full_name: 'บริษัท เอสพีเอ็กซ์ เอ็กซ์เพรส จำกัด (SOCE-บัวโรย)', username: 'SPXadmin02', email: 'SPXadmin02@gmail.com', company_id: 13 },
    { role_id: 3, full_name: 'บริษัท เอสพีเอ็กซ์ เอ็กซ์เพรส จำกัด (SOCN-วังน้อย)', username: 'SPXadmin03', email: 'SPXadmin03@gmail.com', company_id: 14 },
    { role_id: 3, full_name: 'บริษัท เอสพีเอ็กซ์ เอ็กซ์เพรส จำกัด (SOCW-สมุทรสาคร)', username: 'SPXadmin04', email: 'SPXadmin04@gmail.com', company_id: 15 },
